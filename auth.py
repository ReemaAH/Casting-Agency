...
AUTH0_DOMAIN = 'casting-agency-fsdn.us.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'auth'
...
def verify_decode_jwt(token):
    ...
    """
    # I reused part of this function from: https://github.com/kalsmic/Coffee_Shop_Full_Stack/blob/master/backend/src/auth/auth.py
